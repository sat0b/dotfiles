...
keymap("n", "<C-l>", '<Cmd>lua require"fzf-lua".live_grep_glob({ cwd = require"fzf-lua.path".git_root() })<CR>', {})
keymap("n", "<C-g>", '<Cmd>lua require"fzf-lua".grep_project({ cwd = require"fzf-lua.path".git_root() })<CR>', {})
